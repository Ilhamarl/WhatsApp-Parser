    ...
    <div class="container py-5">
        <div class="row">
            <div class="col-md-4 order-md-1">
                <h4 class="mb-3">WhatsApp Parsing V.1</h4>
                ...
                <form method="POST" action="">
                    <div class="row">
                        ...
                        <div class="col-md-12 mb-3">
                            <textarea id="masukan" type="text" name="something" value="<?= isset($_POST['something']) ? htmlspecialchars($_POST['something']) : '' ?>" class="form-control" rows="10">
														</textarea>
                        </div>
                    ...
                    <br>
                    <a href="v2.php" class="btn btn-sm btn-info text-right">Try it <b>Version 2</b></a>
            ...
            <h4 class="mb-3">Parsing Result</h4>
                <div class="row">
                    <div class="col-md-12 mb-3">
                        <!--
												<input type="button" value="Copy" class="btn btn-sm btn-info"
                            onclick="selectElementContents(document.getElementById('tablecopy'));" />
...
?>
        ...
        <script src="https://cdn.datatables.net/buttons/1.5.4/js/dataTables.buttons.min.js" type="text/javascript" charset="utf8"></script>
        <script src="https://cdn.datatables.net/buttons/1.5.4/js/buttons.bootstrap4.min.js" type="text/javascript" charset="utf8"></script>
        ...
        <script src="https://cdn.datatables.net/buttons/1.5.4/js/buttons.html5.min.js" type="text/javascript" charset="utf8"></script>
        <script src="https://cdn.datatables.net/buttons/1.5.4/js/buttons.print.min.js" type="text/javascript" charset="utf8"></script>
        <script src="https://cdn.datatables.net/buttons/1.5.4/js/buttons.colVis.min.js" type="text/javascript" charset="utf8"></script>
